...
export default function EditQuizPage() {
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      try {
        ...
        toast.error('Error cargando quiz: ' + error.message)
      } finally {
        setFetching(false)
      }
    }
  ...
  const generateWithAI = async () => {
    ...
    try {
      ...
      if (!apiKey) {
        throw new Error('Falta la API Key de Google')
      }
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <p className="text-slate-400 mb-4">
              Describí el tema y la IA generará preguntas automáticamente
            </p>
            ...
            <textarea
              ...
              placeholder="Ej: 5 preguntas sobre fracciones para 5to grado..."
            />
